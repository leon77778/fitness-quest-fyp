...
export function haversineDistance(a, b) {// it the code it sayes haversineDistance but it actually uses the pytagoras teorem. i dident chanfe the name for time constraints
